...
export const TaxInformationTab = ({
              ...
              <DropdownMenu
                ...
                items={[
                  ...
                  },
                  {
                    ...
                    icon: <Trash2 className="h-3.5 w-3.5" style={{ color: colors.error[500] }} />,
          ...
          <CardContent className="space-y-4 px-0 pb-4 pt-4">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div className="space-y-1">
                <label className="text-title text-sm font-medium">ชื่อ-นามสกุล</label>
                <p className="text-muted-blue text-sm">
              ...
              {tax.company_name && (
                <div className="space-y-1">
                  <label className="text-title text-sm font-medium">ชื่อบริษัท</label>
                  <p className="text-muted-blue text-sm">{tax.company_name}</p>
                </div>
              )}
              <div className="space-y-1">
                <label className="text-title text-sm font-medium">เลขประจำตัวผู้เสียภาษี</label>
                <p className="text-muted-blue font-mono text-sm">{tax.tax_id}</p>
              </div>
              <div className="space-y-1 md:col-span-2">
                <label className="text-title text-sm font-medium">ที่อยู่</label>
                <p className="text-muted-blue text-sm">
  ...
  return (
    <div className="flex flex-col items-center justify-center px-4 py-20">
      ...
      <p className="text-title mb-8 text-center text-sm">กรุณาสร้างข้อมูลภาษี</p>
      <Button

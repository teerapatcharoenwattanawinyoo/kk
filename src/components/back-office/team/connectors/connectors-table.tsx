          ...
          {isConnectorsLoading ? (
            ...
            connectors.map((connector) => (
              <tr key={connector.id} className="shadow-xs rounded-lg bg-background">
                ...
                <td className="text-muted-blue whitespace-pre-line px-2 py-2 text-center text-xs leading-tight md:px-4 md:py-3">
                  {connector.date}
                  <br />
                  {connector.time}
                </td>
                <td className="text-muted-blue whitespace-nowrap rounded-r-lg px-2 py-2 text-center text-xs md:px-4 md:py-3">

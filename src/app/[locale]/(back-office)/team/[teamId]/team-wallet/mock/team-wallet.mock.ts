import { teamWalletDataSchema } from '../_schemas/team-wallet.schema'

export const teamWalletMockData = teamWalletDataSchema.parse({
  walletBalance: 23780,
  chargeSessions: [
    {
...
export type TeamWalletMockData = typeof teamWalletMockData

...
import { useDeleteTeam } from '../_hooks/use-teams'
import { TeamCardProps } from '../_schemas'
      ...
      <CardHeader className="flex flex-row space-y-2 px-3 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
        <div className="flex min-w-0 flex-1 items-center gap-2">
          ...
          <div className="min-w-0 flex-1">
            <CardTitle className="text-oc-title truncate text-sm font-semibold sm:text-base">
              {team.name}
            </CardTitle>
            <p className="text-oc-sidebar truncate text-xs">

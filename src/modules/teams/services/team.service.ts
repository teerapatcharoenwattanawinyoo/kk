...
const resolveTeamListData = (
  raw: unknown,
  fallback: { statusCode?: number; message?: string },
): TeamListQueryResponse => {
...
export const fetchTeamList = async (params?: TeamListParams): Promise<TeamListQueryResponse> => {
...
export const updateTeamById = async (data: UpdateTeamFormData): Promise<IResponse> => {

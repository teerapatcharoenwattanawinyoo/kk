...
export const useTaxInformation = (teamId?: string) => {
  return useQuery<IResponse<TaxInformationResponse>>({
    ...
    queryFn: () => {
      ...
      return getTaxInformation(teamId)
    },
...
export const useCreateTaxInformation = (teamId?: string) => {
  ...
  return useMutation<IResponse, Error, TaxInformationFormData>({
    mutationFn: async (formData: TaxInformationFormData) => {
      ...
      return createTaxInformation(apiData)
    },
    onSuccess: (data) => {
      ...
      console.log('Tax information created successfully:', data)
    },
    onError: (error) => {
...
export const useUpdateTaxInformation = (teamId?: string) => {
  ...
  return useMutation<IResponse, Error, TaxInformationFormData>({
    mutationFn: async (formData: TaxInformationFormData) => {
      ...
      return updateTaxInformation(teamId, apiData)
    },
    onSuccess: (data) => {
      // อัพเดต cache
      queryClient.invalidateQueries({
      ...
      console.log('Tax information updated successfully:', data)
    },
    onError: (error) => {
...
export const useDeleteTaxInformation = (teamId?: string) => {
  ...
  return useMutation<IResponse, Error, string>({
    mutationFn: async (taxId: string) => {
      ...
      return deleteTaxInformation(taxId)
    },
    onSuccess: (data) => {
      ...
      console.log('Tax information deleted successfully:', data)
    },
    onError: (error) => {
...
export const useTaxInvoiceReceipt = (teamId?: string) => {
  return useQuery<IResponse<TaxInvoiceReceiptResponse>>({
    ...
    queryFn: () => {
      ...
      return getTaxInvoiceReceipt(teamId)
    },
    enabled: !!teamId,
    staleTime: 2 * 60 * 1000, // 2 นาที
    gcTime: 5 * 60 * 1000, // 5 นาที
  ...
  return useMutation<IResponse, Error, TaxInvoiceReceiptData>({
    mutationFn: async (prefixData: TaxInvoiceReceiptData) => {
      ...
      if (currentData?.data?.id) {
        // Update existing
        return updateTaxInvoiceReceipt(teamId, fullData)
      } else {
        // Create new
        return createTaxInvoiceReceipt(fullData)
      }
    },
    onSuccess: (data) => {
      // อัพเดต cache
      ...
      console.log('Invoice number prefix updated successfully:', data)
    },
    onError: (error) => {
...
export const useUpdateReceiptTaxInvoice = (teamId?: string) => {
  ...
  return useMutation<IResponse, Error, ReceiptTaxInvoiceData>({
    ...
    onSuccess: (data) => {
      ...
      console.log('Receipt tax invoice updated successfully:', data)
    },
    onError: (error) => {
...
export const useDeleteTaxInvoiceReceipt = (teamId?: string) => {
  ...
  return useMutation<IResponse, Error, string>({
    mutationFn: async (id: string) => {
      ...
      return deleteTaxInvoiceReceipt(id)
    },
    onSuccess: (data) => {
      // อัพเดต cache
      queryClient.invalidateQueries({
      ...
      console.log('TaxInvoiceReceipt deleted successfully:', data)
    },
    onError: (error) => {

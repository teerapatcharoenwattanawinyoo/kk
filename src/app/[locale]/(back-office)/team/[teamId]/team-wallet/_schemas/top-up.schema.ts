...
export const topUpPresetAmountSchema = z.number().int().positive()
...
export const topUpPageDataSchema = z.object({
  presetAmounts: z.array(topUpPresetAmountSchema),
  transactionGroups: z.array(topUpTransactionGroupSchema),
})
...
export type TopUpPageData = z.infer<typeof topUpPageDataSchema>

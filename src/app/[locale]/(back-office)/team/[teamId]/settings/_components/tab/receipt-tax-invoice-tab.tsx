...
import { ReceiptPreviewDialog } from './receipt-preview/receipt-preview-dialog'
  ...
  return (
    <div className="mx-auto w-full max-w-6xl">
      <div className="mb-8">
        ...
        <h3 className="text-oc-title-secondary mb-8 text-lg font-medium">
          Receipt Tax Invoice Configuration
        </h3>

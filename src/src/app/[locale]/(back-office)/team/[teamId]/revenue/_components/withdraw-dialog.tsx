...
export const WithdrawDialog = memo(({ isOpen, onClose, balance, teamId }: WithdrawDialogProps) => {
          ...
          <div className="relative">
            ...
            <div className="space-y-6 p-6">
              ...
              {!hasPhone && !hasEmail ? (
                ...
                <Tabs
                  value={otpMethod}
                  onValueChange={(value: string) => setOtpMethod(value as OTPMethod)}
                  className="w-full"
                >
            ...
            <div className="flex space-x-3 border-t border-gray-200 p-6">
              ...
              <Button
                ...
                className="flex-1 bg-blue-600 text-white hover:bg-blue-700"
                disabled={(!hasPhone && !hasEmail) || initPayoutMutation.isPending}
              >
                {initPayoutMutation.isPending ? 'กำลังส่ง OTP...' : 'Send OTP'}
              </Button>
            </div>
          </div>
        )
      ...
      case 'verifyOTP':
        return (
          <div className="relative">
            ...
            <div className="space-y-6 p-6">
              <div className="text-center">
                <h3 className="mb-2 text-xl font-semibold text-gray-900">Verify OTP</h3>
              ...
              <div className="text-center text-sm text-gray-600">
                ...
                {initResponse?.otp_ref && <p>Ref : #{initResponse.otp_ref}</p>}
              </div>
            </div>
            ...
            <div className="flex space-x-3 border-t border-gray-200 p-6">
              ...
              <Button
                ...
                className="flex-1 bg-blue-600 text-white hover:bg-blue-700"
                disabled={
                  otp.join('').length !== 6 || confirmPayoutMutation.isPending || timeLeft <= 0
                }
              >

    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="h-auto max-w-4xl">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-text-oc-construction-soft text-text-oc-construction items-center rounded-md px-3 py-4 text-sm">
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl">
        <DialogHeader>
          <DialogTitle className="text-oc-title-secondary text-2xl font-bold">
            Select Station
          </DialogTitle>
        </DialogHeader>
      ...
      <CardContent className="space-y-8 pt-6">
        ...
        <div>
          ...
          <div className="mb-2">
            <Badge
              variant="secondary"
              className="bg-text-oc-construction-soft text-text-oc-construction border font-normal"
            >
              <Info />

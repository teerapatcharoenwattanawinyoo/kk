...
export const requestTeamList = (params?: TeamListParams) => getTeamListApiRequest(params)

export const requestLegacyTeamList = () => getTeamListRequest()

export const requestTeamHostList = (params?: TeamHostListParams) => getTeamHostListRequest(params)
...
export const requestUpdateTeam = (teamId: string, formData: FormData): Promise<IResponse> => {

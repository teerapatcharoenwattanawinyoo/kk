...
import { useTaxInvoiceReceipt, useUpdateInvoiceNumberPrefix } from '@/hooks/use-tax'
...
export const InvoiceNumberPrefixTab = ({ teamId }: InvoiceNumberPrefixTabProps) => {
  ...
  return (
    <div className="">
      ...
      {/* Header */}
      <div className="mb-6">
        <h3 className="text-title mb-4 text-lg font-semibold">Header : Receipt</h3>
      ...
      <div className="mb-8">
        <h4 className="text-title mb-4 text-base font-semibold">Select Type Document</h4>
      ...
      {/* Starting Number */}
      <div className="mb-8">
        <h4 className="text-title mb-4 text-base font-semibold">Starting Number</h4>

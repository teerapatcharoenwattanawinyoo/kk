...
export default function PriceGroupForm({
  ...
  const resolvedBillingType: BillingType = billingType ?? initialData?.billingType ?? 'USAGE'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!validationResult.success) {
      ...
      toast.error(errorMessage || 'Please check the form fields and try again.')
      return
    }
      ...
      <div className="max-w-640 bg-sidebar mx-auto flex w-full flex-col rounded-lg md:p-8">
        ...
        <div className="flex items-center justify-between border-b pb-4">
          <div className="flex items-center gap-4">
            <Button variant="secondary" size="icon" onClick={onBack} className="rounded-full">
              ...
              <div className="flex flex-col lg:flex-row">
                ...
                <div
                  className={cn(
                    ...
                    isUsageBilling
                      ? 'lg:w-1/4 lg:border-b-0 lg:border-r lg:pr-8'
                      : 'lg:w-full lg:border-b-0',
                  )}
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      <SelectTrigger
                        className={`mt-2 ${form.status ? 'text-oc-title' : 'text-oc-title'}`}
                      >

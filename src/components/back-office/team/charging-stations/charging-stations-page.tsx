"use client";
import { AddChargingStationDialog } from "@/components/back-office/team/add";
import { ChargingStationsTable } from "@/components/back-office/team/charging-stations";
import { TeamHeader } from "@/components/back-office/team/team-header";
import { Button } from "@/components/ui/button";
import { convertStationDetailToFormData } from "@/lib/api/team-group/charging-station";
import {
...
import { getChargingStationDetail } from "@/lib/api/team-group/charging-station";
...
import { EditsChargingStationDialog } from "../edit";
...
export function ChargingStationsPage({ teamId }: ChargingStationsPageProps) {
  ...
  const [selectedStation, setSelectedStation] =
    useState<ChargingStationFormData | null>(null);
  ...
  return (
    <div className="flex min-h-[calc(100vh-4rem)] flex-col">
      ...
      <TeamHeader
        teamId={teamId}
        pageTitle={t("team_tabs.charging_stations")}
      />
            ...
            <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
              <div className="flex flex-col items-center space-y-2 sm:flex-row sm:space-x-4 sm:space-y-0">
                <div className="text-sm font-light text-foreground">
                  ...
                  {t("pagination.of")} {totalItems} {t("pagination.result")}
                </div>
                  ...
                  if (startPage > 1) {
                    ...
                    if (startPage > 2) {
                      pageNumbers.push(
                        <span
                          key="ellipsis-start"
                          className="px-2 font-light text-[#606266]"
                        >
                          ...
                        </span>,
                      );
                  ...
                  if (endPage < totalPages) {
                    if (endPage < totalPages - 1) {
                      pageNumbers.push(
                        <span
                          key="ellipsis-end"
                          className="px-2 font-normal text-[#606266]"
                        >
                          ...
                        </span>,
                      );

...
export const userSchema = z.object({
  ...
  email: z.union([z.string().email(), z.null()]).transform((value) => value ?? ''),
...
export const registerByEmailResponseSchema = createApiResponseSchema(registerByEmailDataSchema)
...
export const registerByPhoneResponseSchema = createApiResponseSchema(registerByPhoneDataSchema)
